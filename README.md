Fork of **disaster37** https://github.com/disaster37/terraform-provider-kibana with some additional stuff. I will try to find some time and create PR to upstream someday.
